...
const updatePosition = position => {
    ...
    // loca.push(position.coords.longitude.toFixed(3))

    // console.log(`Current Latitude is ${position.coords.latitude.toFixed(3)} and your longitude is ${position.coords.longitude.toFixed(3)}`);
}
